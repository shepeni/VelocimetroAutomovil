...
enum Velocidades: Int{
    case Apagado = 0, VelocidadBaja = 20, VelocidadMedia = 50, VelociadadAlta = 120
    
    init (velocidadInicial: Velocidades){
        self = velocidadInicial
        print((self.rawValue, "Apagado"))
    }
}
...
class Auto{
    ...
    func cambioDeVelocidad () -> (actual: Int, velocidadEnCadena: String){
        ...
        case Velocidades.VelocidadMedia:
            velocidad = Velocidades.VelociadadAlta
            return (velocidad.rawValue, "Velocidad Media")
        case Velocidades.VelociadadAlta:
            velocidad = Velocidades.VelocidadMedia
